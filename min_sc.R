...
q_obs_min <- read.csv("F:/lexi/min_sc_TxtInOut/min_river.csv")
...
#### Step 3 calibrate ####======================================================
par_test_yie <- tibble("ALPHA_BF.gw | change = absval | sub = 1:94" = 0.40,
